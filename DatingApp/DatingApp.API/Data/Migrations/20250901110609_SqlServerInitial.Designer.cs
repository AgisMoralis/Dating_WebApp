...
namespace DatingApp.API.Data.Migrations
{
    ...
    [Migration("20250901110609_SqlServerInitial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatingApp.API.Entities.MemberRole", b =>
                {
            ...
            modelBuilder.Entity("DatingApp.API.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatingApp.API.Entities.MemberRole", b =>
                {
                    b.HasOne("DatingApp.API.Entities.Role", "Role")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("DatingApp.API.Entities.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("DatingApp.API.Entities.Member", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
